...
export const sportData = {
    ...
    items: {
        ...
        second_row: [
            { name: "Swiming", icon: <FontAwesome6 name="person-swimming" size={50} color="white" /> },
            { name: "Karate", icon: <MaterialCommunityIcons name="yoga" size={50} color="white" /> },
            { name: "Taekwondo", icon: <MaterialCommunityIcons name="boxing-glove" size={50} color="white" /> },
            { name: "Capoeira", icon: <MaterialIcons name="sports-mma" size={50} color="white" /> },
        ]
    }
};
